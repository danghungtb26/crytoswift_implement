...
class SecureCardPinTextField : UIView, SecureTextProtocol {
    ...
    @objc var placeholderTextColor: String = "" {
        didSet {
		    ...
		    string: self.securePasswordField.placeholder != nil ? self.securePasswordField.placeholder! : "Card Pin",
    ...
    lazy var securePasswordField: SecureTextField = {
        let textFiled = SecureCardPinField()
