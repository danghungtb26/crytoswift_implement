...
class SecurePasswordTextField : UIView, SecureTextProtocol {
    ...
    @objc var placeholderTextColor: String = "" {
        didSet {
		    ...
		    string: self.securePasswordField.placeholder != nil ? self.securePasswordField.placeholder! : "Password",
    ...
    lazy var securePasswordField: SecureTextField = {
        let textFiled = SecurePasswordField()
...
//                    print(data)
                    ...
                    self.onCreateTokenAction?(["value": data.first?.value])
